/*
 * PGS rect splitting (sub_find_gap) test.
 *
...
static int test_no_gap(void)
{
    ...
    if (sub_find_gap(buf, W * 4, W, 64, &gs, &ge) != 0) {
...
static int test_gap_too_small(void)
{
    ...
    if (sub_find_gap(buf, W * 4, W, h, &gs, &ge) != 0) {
...
static int test_exact_threshold(void)
{
    ...
    if (sub_find_gap(buf, W * 4, W, h, &gs, &ge) != 1) {
